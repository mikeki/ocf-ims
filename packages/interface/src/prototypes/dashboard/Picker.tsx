...
// Native: harness chrome, deliberately NOT on the app's tokens. Bottom
// centre, the spec's default — nothing in this round docks there.
...
export function Picker(props: PickerProps) {
  ...
  return (
    <View
      ...
      style={[styles.anchor, { bottom: 24 + insets.bottom }]}
    >
