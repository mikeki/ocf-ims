...
| [09k-interface-scaffold.md](09k-interface-scaffold.md) | Phase 3, slice 3a.1 — `packages/interface` scaffold: Expo SDK 57 + Router in the pnpm workspace, generated-TS wiring, `pnpm generate`, jest-expo, Playwright smoke on the web export, the `Interface` CI job | Built — for review |
