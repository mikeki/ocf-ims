...
| [09x-dispatch-design.md](09x-dispatch-design.md) | Phase 3, slice 3c.0 — D2, dispatch on a wide screen: what the wire gives the table, the shell question, the prototype round (Split / Drawer / Page), the URL schema, keyboard map and live-row rules 3c.1 inherits | **Brief written** 2026-09-13; the round is the maintainer's |
