...
| [09b-core-domain.md](09b-core-domain.md) | Phase 0, slice 0b — resources/v1 messages (incident, report, journal entry, involvement, linked incident, area, event) + vendored protovalidate | In progress — for review |
