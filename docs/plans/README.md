...
| [09d-taxonomies-admin.md](09d-taxonomies-admin.md) | Phase 0, slice 0d — resources/v1 taxonomies & admin (incident type, outcome, action log, notification, metrics) + visit; completes resources/v1 | In progress — for review (PR #203) |
