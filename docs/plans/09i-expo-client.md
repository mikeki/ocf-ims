...
| **3a.4 Design system v0 applied** → [09o](09o-design-v0.md) | D0 picker → Builder | D0 done ("Dispatch"), tokens + `DESIGN.md` landed; tokens generated; primitives restyled; tracer screens re-skinned; dark mode. Screenshots ×3 platforms in the PR. | D0, 3a.3 |
