...
| Step | Owner | Output |
|---|---|---|
| D0 — Design system v0 (during 3a) → [09o](09o-design-v0.md) | Claude Design or an in-code prototype run (09o), reviewed by Miguel | Tokens (colour incl. dark mode, type scale, spacing, radii, elevation), primitives (button, field, list row, badge, sheet, tab bar, toolbar), the state/priority colour language (plan 93 states), brand (icon, splash). A `DESIGN.md` recording the direction in words. |
...
| **3a.4 Design system v0 applied** → [09o](09o-design-v0.md) | Claude Design → Builder | D0 bundle; tokens generated; primitives restyled; tracer screens re-skinned; dark mode. Screenshots ×3 platforms in the PR. | D0, 3a.3 |
