...
| D2 — Dispatch (for 3c) → [09x](09x-dispatch-design.md) (the shell, the table, where an incident opens — for 3c.1) → [09y](09y-incident-editor-design.md) (the editor — for 3c.2) → [09z](09z-reports-design.md) (the report pane — for 3c.3) → [09aa](09aa-roster-design.md) (the roster — for 3c.4; the dashboard gets its round with its slice) | Claude Design, or an in-code picker round per flow | Wide-screen prototypes: split list/detail, dense incident table with filters, the full incident editor, report review, roster, dashboard. Keyboard flow noted per screen. |
