...
--   'mentioned'         — you were @mentioned in a journal entry (plan 81).
...
-- the notification (for linking and access); INCIDENT_NUMBER/JOURNAL_ENTRY are
-- type-dependent sources; ACTOR is who caused it (null for system actions).
