...
const url_incidentPerson = "/ims/api/events/<event_id>/incidents/<incident_number>/people/<person_handle>";
...
const url_report_reportEntries = "/ims/api/events/<event_id>/reports/<report_number>/report_entries";
const url_report_reportEntry = "/ims/api/events/<event_id>/reports/<report_number>/report_entries/<report_entry_id>";
...
const url_visit_reportEntry = "/ims/api/events/<event_id>/visits/<visit_number>/report_entries/<report_entry_id>";
...
const url_viewPlaces = "/ims/app/events/<event_id>/places";
