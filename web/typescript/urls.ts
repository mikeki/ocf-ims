...
const url_authPassword = "/ims/api/auth/password";
const url_authProfile = "/ims/api/auth/profile";
const url_authPicture = "/ims/api/auth/picture";
...
const url_proposeOutcome = "/ims/api/events/<event_id>/outcomes";
...
const url_notifications = "/ims/api/notifications";
const url_notificationsRead = "/ims/api/notifications/read";
const url_notificationRead = "/ims/api/notifications/<notification_id>/read";
...
const url_adminOutcomes = "/ims/app/admin/outcomes";
const url_adminOutcomesJS = "/ims/static/admin_outcomes.js";
...
const url_viewCrews = "/ims/app/events/<event_id>/crews";
